...
namespace SplitViewMenu
{
    public sealed class SplitViewMenu : Control
    {
        ...
        private NavMenuListView _navMenuBottomListView;
        ...
        private static void OnBottomNavigationItemsPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (menu._navMenuBottomListView != null)
                menu._navMenuBottomListView.ItemsSource = e.NewValue;
        }
        ...
        protected override void OnApplyTemplate()
        {
            ...
            _navMenuBottomListView = GetTemplateChild("BottomNavMenuList") as NavMenuListView;
            _backButton = GetTemplateChild("BackButton") as Button;

            if (_navMenuBottomListView != null)
            {
                _navMenuBottomListView.ItemInvoked += OnNavMenuItemInvoked;
                _navMenuBottomListView.ContainerContentChanging += OnContainerContextChanging;
            }
